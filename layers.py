...
class WaveNet():
    def __init__(self, in_channels, out_channels, kernel_size, stack_size, layer_size):
        ...
        self.casualConv1d = CasualDilatedConv1d(in_channels, in_channels, kernel_size, dilation=1)
        self.stackResBlock = StackResidualBlock(self.stack_size, self.layer_size, in_channels, out_channels, kernel_size)
        self.denseLayer = DenseLayer(out_channels)
    ...
    def to(self, device):
        ...
        self.stackResBlock = self.stackResBlock.to(device)
    ...
    def parameters(self):
        ...
        params += self.stackResBlock.parameters()
    ...
    def forward(self, x):
        ...
        skip_connections = self.stackResBlock(output, output_size)
